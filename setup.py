...
sources = [
    ...
    str(PROJECT_ROOT / "torch_interface" / "warp_wrapper.cpp"),
    str(PROJECT_ROOT / "torch_interface" / "warp_smem_wrapper.cpp"),
    str(PROJECT_ROOT / "torch_interface" / "warp_smem_fp4_wrapper.cpp"),
    str(PROJECT_ROOT / "torch_interface" / "warp_fp4_wrapper.cpp"),   # 🔹 NEW
    ...
    str(PROJECT_ROOT / "src" / "device" / "csrspmm_warp_per_row_fp4.cu"),      # 🔹 kernel 2
    str(PROJECT_ROOT / "src" / "device" / "csrspmm_warp_per_row_smem_fp4.cu"), # kernel 3
    str(PROJECT_ROOT / "src" / "device" / "csrspmm_warp_per_row_smem.cu"),     # kernel 4
    str(PROJECT_ROOT / "src" / "device" / "csrspmm_warp_per_row.cu"),          # kernel 5
]
