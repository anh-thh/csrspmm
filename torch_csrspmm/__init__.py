...
from ._C import csrspmm_warp_per_row_smem_fp4 as _csrspmm_warp_per_row_smem_fp4
...
def csrspmm_warp_per_row_smem_fp4(A_rowptr, A_colidx, A_values, A_max_row_nnz, B, alpha, beta):
    return _csrspmm_warp_per_row_smem_fp4(A_rowptr, A_colidx, A_values, A_max_row_nnz, B, alpha, beta)
